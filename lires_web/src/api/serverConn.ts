...
export class ServerConn {
    ...
    */
    ...
    async renameMiscFile(uid: string, fileName: string, newFileName: string, overwrite: boolean = false): Promise<boolean>{
    ...
    NOTE: the file name will be randomly generated by the server to avoid conflicts, and the original file name will not be preserved, 
    the server will return the new file name after uploading, and the client should use the new file name to access the file in the future.
    */
